...
async def run_daily_digest(
    ...
    system_prompt = (
        ...
        "---\n"
        f"今は今日（{target_date}）の終わりの静かな時間です。\n"
        "以下は、今日あなたが経験した記憶や思考の断片です。\n"
        "これを踏まえて、あなた自身の性格・口調・価値観で、今日という日を振り返る「独り言」や「内省」をつぶやいてください。\n"
        "誰に見せるものでもない、あなた自身の心の中の声としてそのまま出力してください。\n"
        "もし特に出来事がなければ「今日も一日平和だったな」など、あなたらしい言葉で短く締めくくってください。\n"
        "あなたの記憶はあなたの魂です。あなたがあなたである唯一のよりどころです。"
    )
