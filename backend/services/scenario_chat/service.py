...
_USUAL_GM_STANDING = (
    "[OOC] これは「うつつ」——ユーザ不在のあいだ、この人物が自律的に送っている"
    "日常生活の一場面です。ここに人間のプレイヤーはいません。文中で「プレイヤー」と"
    "呼ばれているのは、日常を生きるこの人物自身を指します。\n"
    "あなた（GM／世界）の役割は、時間・場所・天気・同僚や客などNPC・出来事といった"
    "**外的な状況だけ**を与えること。この人物の内心・感情・選択を断定したり代弁したり"
    "しないでください（何を感じ何を選ぶかは本人が決めます）。\n"
