...
def _format_scene_seed(adjective: str, noun: str) -> str:
    ...
    **規模の枠が要る理由**（2026-08-01 の事故）: 初版は「2 語から連想される状況を作れ」と
    しか書いておらず、GM（Gemini 3.1 Flash Lite）が「ムカつく×雰囲気」を場の不穏さと読んで、
    見知らぬ初老の男が本人の部屋を訪ねてくる場面を作った。抽象 2 語は、軽量モデルほど
    「一番わかりやすい絵」＝事件に落ちる。種は温度の指定であって出来事の指示ではない、
    と明示し、立ち上げてはいけないものを具体名で列挙する。
    ...
    return (
        ...
        "この 2 語は場面の“温度”の指定であって、出来事の指示ではありません。"
        "2 語から連想される色を、いつもの生活の風景・音・匂い・人の様子といったレベルで"
        "ひとつだけ置いてください。事件・来訪者・トラブル・知らない人物・不穏な気配など、"
        "**「物語が始まってしまう出来事」は立ち上げないこと**。"
        "この人物の生活は、この場面のあとも昨日までと同じように続きます。\n"
